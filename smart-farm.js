...
const CROP_SCHEDULES = {
  tomato: [
    { stage: "ჩითილი / ადრული ვეგეტაცია", days: [0, 25], fungicide: "აზოქსისტრობინი (ალტერნარიოზი) + ციმოქსანილი+მანქოზები (ფიტოფთოროზი)", insecticide: "დიმეთოატი (ბუგრები / ნადგარები) + ციპერმეთრინი (ბუგრები)", fertilizer: "სუპერფოსფატი (სტარტერი)", notes: "გადარგვამდე ნიადაგი ტრიქოდერმინით დაამუშავეთ" },
    { stage: "ვეგეტაცია", days: [25, 50], fungicide: "მანქოზები (ფიტოფთოროზი / ალტერნარიოზი პროფილაქტიკა)", insecticide: "მეთომილი (ჩია / ბუგრები) + პირეთროიდი / აცეტამიპრიდი (სპიური)", fertilizer: "NPK 15-15-15 + მიკროელემენტები", notes: "7-10 დღეში ვიზუალური დათვალიერება სავალდებულოა" },
    { stage: "ყვავილობა", days: [50, 75], fungicide: "ფამოქსადონი+ციმოქსანილი (ფიტოფთოროზი) + მანდიპროპამიდი (ნაცარი)", insecticide: "ქლორანტრანილიპროლი (მოზია — ტომატის ჩრჩილი) + ციპერმეთრინი (ბუგრები)", fertilizer: "ბორი + კალიუმი (ფოთლოვანი)", notes: "შეწამვლა დილით ან საღამოს — ფუტკრების დაცვა" },
    { stage: "ნაყოფის შეკვრა / მცირე ნაყოფი", days: [75, 100], fungicide: "მეტალაქსილი-M+მანქოზები (ფიტოფთოროზი) + სპილენძის ჰიდროქსიდი (სეპტორია)", insecticide: "ინდოქსაკარბი (მოზია / სპოდოპტერა) + სპირომეზიფენი (ტკიპები)", fertilizer: "კალიუმის სულფატი — დოზა გაზარდეთ", notes: "ფიტოფთოროზის მონიტორინგი ყოველდღე" },
    { stage: "ნაყოფის ზრდა", days: [100, 125], fungicide: "მეტალაქსილი-M+მანქოზები (ფიტოფთოროზი) + ციმოქსანილი+მანქოზები (ალტერნარიოზი)", insecticide: "მეთომილი (ჩია) + ინდოქსაკარბი (მოზია)", fertilizer: "კალიუმი + კალციუმი", notes: "ნაყოფის ზრდისას კალციუმის დოზა გაზარდეთ" },
    { stage: "მომწიფება", days: [125, 160], fungicide: "მანქოზები + სპილენძის ჰიდროქსიდი (ფიტოფთოროზი / სეპტორია)", insecticide: "ინდოქსაკარბი (მოზია / ჩია)", fertilizer: "სასუქი მინიმუმამდე შეამცირეთ", notes: "მოსავლამდე 7-14 დღე — ქიმიური შეწამვლა შეწყვიტეთ" },
  ],
  pepper: [
    { stage: "ჩითილი / გადარგვა",    days: [0, 30],    fungicide: "Bacillus subtilis (ფესვების დამუშავება)", insecticide: "საჭირო არ არის", fertilizer: "სტარტ. NPK (ფოსფორი)", notes: "ფიტოფტოროზის საწინააღმდეგო ნიადაგი" },
    { stage: "ვეგეტაცია",             days: [30, 60],   fungicide: "სპილენძის სულფატი — 10 დღეში ერთხელ", insecticide: "იმიდაკლოპრიდი (ბუგრის საწინააღმდეგოდ)", fertilizer: "NPK 15-15-15", notes: "" },
    { stage: "ყვავილობა",             days: [60, 85],   fungicide: "დიფენოკონაზოლი / ბოსკალიდი+პირაკლოსტრობინი (ნაცარი / სიდამდავრება)", insecticide: "ლამბდა-ციჰალოტრინი (საჭიროების შემთხვევაში)", fertilizer: "ბორი + კალიუმი (ფოთლოვანი შეწამვლა)", notes: "ბოტრიტისის კონტროლი მნიშვნელოვანია" },
    { stage: "ნაყოფის ზრდა",          days: [85, 120],  fungicide: "მეტალაქსილი-M (ფიტოფტოროზის საწინა��ღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმის დოზა გაზარდეთ", notes: "პიკ სეზონზე მორწყვის სტაბილურობა" },
    { stage: "მოსავალი",              days: [120, 160], fungicide: "საჭირო არ არის", insecticide: "საჭირო არ არის", fertilizer: "საჭირო არ არის", notes: "მოსავლამდე 10 დღე — პესტიციდების შეჩერება" },
  ],
  cucumber: [
    { stage: "ჩითილი / ნიადაგის მომზადება", days: [0, 20], fungicide: "პროპამოკარბი+ფოსეტილ-Al (ჩრაქი / Pythium ფესვის დაავადება)", insecticide: "ეთოპროფოსი (ნემატოდები / ნიადაგის მავნებლები)", fertilizer: "NPK სტარტერი (ფოსფორი)", notes: "გადარგვამდე ნიადაგი ტრიქოდერმინით დაამუშავეთ; ჭრაქის რისკი კრიტიკული" },
    { stage: "ადრული ვეგეტაცია (2-3 ფოთოლი)", days: [20, 40], fungicide: "პროპინები (ჭრაქი / ალტერნარიოზი პროფილაქტიკა)", insecticide: "იმიდაკლოპრიდი (ბუგრები / სპიური)", fertilizer: "NPK 15-15-15", notes: "ჭრაქი — ტენიანობისას კრიტიკული; 5-7 დღეში დათვალიერება" },
    { stage: "ინტენსიური ვეგეტაცია", days: [40, 55], fungicide: "პროპინები+ფლუაზინამი (ჭრაქი / ფიტოფთოროზი / ალტერნარიოზი)", insecticide: "თიამეთოქსამი (ბუგრები / სპიური / თრიფსი)", fertilizer: "N + კალიუმი", notes: "ჭრაქი + ფიტოფთოროზი — ვეგეტაციის ყველაზე სახიფათო დაავადება" },
    { stage: "ყვავილობამდე", days: [55, 65], fungicide: "მეტალაქსილი-M (ფიტოფთოროზი) + პროპინები (ჭრაქი / ალტერნარიოზი)", insecticide: "ლამბდა-ციჰალოტრინი (ბუგრები / თრიფსი) + სპიროდიკლოფენი (ტკიპები)", fertilizer: "ბორი (ფოთლოვანი) + კალციუმი", notes: "შეწამვლა დილით ან საღამოს — ფუტკრების დაცვა" },
    { stage: "ყვავილობა", days: [65, 75], fungicide: "ციპროდინილი+ფლუაზინამი (ნაცარი / ბოტრიტისი)", insecticide: "საჭირო არ არის", fertilizer: "ბორი + კალიუმი", notes: "შეწამვლა მინიმუმი — მხოლოდ გათენებისას ან საღამოს" },
    { stage: "ნაყოფების ჩამოყალიბება", days: [75, 90], fungicide: "ბოსკალიდი+პირაკლოსტრობინი (ნაცარი / ბოტრიტისი / ანთრაქნოზი)", insecticide: "თიამეთოქსამი (სპიური / ბუგრები) + აბამექტინი (ტკიპები)", fertilizer: "კალიუმი + კალციუმი", notes: "ბოტრიტისი — ყვავილობის შემდეგ ჩამოყალიბებისას ყველაზე სახიფათო" },
    { stage: "ნაყოფების ზრდა / განვითარება", days: [90, 115], fungicide: "პროპინები+ფლუაზინამი (ჭრაქი / ფიტოფთოროზი) + ციპროდინილი (ნაცარი)", insecticide: "ლამბდა-ციჰალოტრინი (ბუგრები / თრიფსი) + ციფლუმეტოფენი (ტკიპები)", fertilizer: "კალიუმი", notes: "5-7 დღეში ერთხელ შეწამვლა; ფიტოფთოროზის მონიტორინგი ყოველდღე" },
    { stage: "კრეფის ეტაპი", days: [115, 145], fungicide: "პროპინები (ჭრაქი / ალტერნარიოზი)", insecticide: "თიამეთოქსამი (სპიური / ბუგრები)", fertilizer: "კალიუმი (ნაკლები დოზა)", notes: "3-5 დღე — ქიმიური შეწამვლა შეწყვიტეთ" },
  ],
  potato: [
    { stage: "გამოღივება",            days: [0, 25],    fungicide: "Bacillus subtilis (ტუბერის დამუშავება)", insecticide: "იმიდაკლოპრიდი (ხოჭოს საწინააღმდეგოდ)", fertilizer: "NPK სტარტ. (ფოსფორი)", notes: "ტუბერის წინასწარ დამუშავება სავალდებულოა" },
    { stage: "ვეგეტაცია",             days: [25, 50],   fungicide: "მეტირამი (ფიტოფტოროზის პროფილაქტიკა)", insecticide: "ლამბდა-ციჰალოტრინი (კოლორადოს ხოჭოს საწინააღმდეგოდ)", fertilizer: "NPK 15-15-15 + კალციუმი", notes: "კოლორადოს ხოჭოს ყოველდღე თვალყური" },
    { stage: "ტუბერის წარმოქმნა",     days: [50, 75],   fungicide: "მეტალაქსილი-M (ფიტოფტოროზის საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმის დოზა გაზარდეთ", notes: "ფიტოფტოროზის მაღალი სეზონი" },
    { stage: "სიმწიფე",               days: [75, 110],  fungicide: "დიფენოკონაზოლი (სიდამდავრების საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "სასუქი შეამცირეთ", notes: "მოსავლამდე 14 დღე — ქიმიური შეწამვლის შეჩერება" },
  ],
  maize: [
    { stage: "გაღივება",              days: [0, 20],    fungicide: "Bacillus subtilis (თესლის დამუშავება)", insecticide: "საჭირო არ არის", fertilizer: "NPK 10-20-20 სტარტ.", notes: "თესლის დამუშავება სავალდებულოა" },
    { stage: "ვეგეტაცია (3-6 ფოთოლი)", days: [20, 45], fungicide: "საჭირო არ არის", insecticide: "ლამბდა-ციჰალოტრინი (ჭიების საწინააღმდეგოდ)", fertilizer: "ნიტრამონი (N — 1-ლი დოზა)", notes: "ჰერბიციდი — 3-4 ფოთლის ფაზაში" },
    { stage: "ძლიერი ზრდა",           days: [45, 70],   fungicide: "დიფენოკონაზოლი (ჟანგი / ჰელმინტოსპოროზი)", insecticide: "ტებუფენოზიდი (ღეროს ჭიის საწინააღმდეგოდ)", fertilizer: "ნიტრამონი (N — 2-ე დოზა)", notes: "ღეროს ჭია — ყველაზე სახიფათო" },
    { stage: "ყვავილობა",             days: [70, 90],   fungicide: "საჭირო არ არის", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი + ბორი", notes: "შეწამვლა ყვავილობისას არ შეიძლება" },
    { stage: "მარცვლის ფორმირება",    days: [90, 120],  fungicide: "საჭირო არ არის", insecticide: "საჭირო არ არის", fertilizer: "საჭირო არ არის", notes: "მორწყვა კრიტიკულია ამ ფაზაში" },
  ],
  wheat: [
    { stage: "გაღივება",              days: [0, 30],    fungicide: "თესლის პრეპარატი (TMTD / ვიტავაქსი)", insecticide: "საჭირო არ არის", fertilizer: "NPK სტარტ. (ფოსფორი)", notes: "თესლის დასაცავად დამუშავება სავალდებულოა" },
    { stage: "კოკრიანობა",            days: [30, 80],   fungicide: "დიფენოკონაზოლი (სეპტორია / ჟანგი)", insecticide: "საჭირო არ არის", fertilizer: "ნიტრამონი — ტოპდრესინგი (გაზაფხულზე)", notes: "გაზაფხულის აზოტი — ყველაზე მნიშვნელოვანი" },
    { stage: "ღეროს ზრდა",            days: [80, 120],  fungicide: "დიფენოკონაზოლი / ბოსკალიდი+პირაკლოსტრობინი (სეპტ. / ჟანგი)", insecticide: "ლამბდა-ციჰალოტრინი (ბუგრი / თრიფსი)", fertilizer: "N — 2-ე დოზა", notes: "ჟანგის მონიტორინგი ყოველ 5 დღეში" },
    { stage: "ყვავილობა",             days: [120, 145], fungicide: "ბოსკალიდი+პირაკლოსტრობინი (ფუზარიოზის საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "საჭირო არ არის", notes: "ყვავილობის ფაზა — ფუზარიოზის კრიტიკული დრო" },
    { stage: "სიმწიფე",               days: [145, 200], fungicide: "საჭირო არ არის", insecticide: "საჭირო არ არის", fertilizer: "საჭირო ა�� არის", notes: "14+ დღე — ქიმიური შეწამვლის შეჩერება" },
  ],
  vine: [
    { stage: "მოსვენება / ადრ. გაზ. შეწ.", days: [0, 15], fungicide: "სპილენძის ჰიდროქსიდი (ქეცი, შავი ლპობა)", insecticide: "mineral oil (ფარიანა, ცვილა)", fertilizer: "საჭირო არ არის", notes: "კვირტის გაშლამდე — +8°C. სეზონის 1-ლი შეწამვლა სავალდებულოა" },
    { stage: "კვირტის გაშლა / 3-5 ფოთოლი", days: [15, 40], fungicide: "სპილენძის სულფატი (ჭრაქი, ქეცი)", insecticide: "იმიდაკლოპრიდი (ბუგრები)", fertilizer: "N — კვირტის გაშლის წინ", notes: "ჭრაქი კრიტიკული დასაწყისი: ყოველ 7 დღეში მონიტორინგი" },
    { stage: "5-8 ფოთოლი / კოჭის ჩამოყალ.", days: [40, 65], fungicide: "მეტირამი + დიფენოკონაზოლი (ჭრაქი + ნაცარი)", insecticide: "ლამბდა-ციჰალოტრინი (Lobesia botrana — 1-ლი თაობა)", fertilizer: "NPK დაბალანსებული", notes: "ნაცარი + ჭრაქი ერთდროულად! სისტემური ფუნგიციდი სავალდებულოა" },
    { stage: "ყვავილობამდე", days: [65, 80], fungicide: "მეტალაქსილი-M (ჭრაქი) + ციპროდინილი+ფლუდიოქსონილი (ბოტრიტისი)", insecticide: "ტებუფენოზიდი (Lobesia botrana — 1-ლი თაობა)", fertilizer: "ბორი (ფოთლოვანი) + კალციუმი", notes: "ყვავილობამდე 1 კვირა — ბოტრიტისის ყველაზე კრიტიკული შეწამვლა" },
    { stage: "ყვავილობა", days: [80, 90], fungicide: "გოგირდი (ნაცარი — მხოლოდ საჭიროების შემთხვევაში)", insecticide: "საჭირო არ არის", fertilizer: "ბორი (ყვავილობის პოტენციალი)", notes: "ფუტკრები! შეწამვლა მინიმუმი — მხოლოდ გათენებისას ან მზის ჩასვლის შემდეგ" },
    { stage: "მარცვლის ჩამოყალ. (1-5 mm)", days: [90, 115], fungicide: "ბოსკალიდი+პირაკლოსტრობინი (ნაცარი / ბოტრიტისი)", insecticide: "აბამექტინი (ტკიპები) + ლამბდა-ციჰალოტრინი (2-ე თაობა Lobesia)", fertilizer: "კალიუმი + კალციუმი", notes: "მარცვლის ჩამოყალ. — ბოტრიტისის მე-2 კრიტიკული ფაზა" },
    { stage: "მარცვლის ზრდა / ვერაიზონი", days: [115, 145], fungicide: "ციპროდინილი+ფლუდიოქსონილი (ბოტრიტისი / სიდამდავრება)", insecticide: "ტებუფენოზიდი (Lobesia botrana — 3-ე თაობა)", fertilizer: "კალიუმი (ხარისხი + შაქრიანობა)", notes: "ვერაიზონი — ბოტრიტისი ყველაზე სახიფათო, 21 დღე კარანტინი" },
    { stage: "სიმწიფე / მოსავალი", days: [145, 185], fungicide: "საჭირო არ არის (21+ დღე შეწამვლის გარეშე)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი (ნაკლები დოზა)", notes: "21 დღე — ქიმიური შეწამვლა სავალდებულოდ შეწყვიტეთ! მოსავლის დათვალიერება ყოველ 3 დღეში" },
    { stage: "შემოდგომა / გასხვლა", days: [185, 210], fungicide: "სპილენძის ჰიდროქსიდი (გასხვლის შემდეგ ჭრილობების დასამუშ.)", insecticide: "საჭირო არ არის", fertilizer: "საჭირო არ არის", notes: "ჭრის ჭრილობების დამუშავება სავალდებულოა" },
  ],
  apple: [
    { stage: "მოსვენების პერიოდი", days: [0, 15], fungicide: "საჭირო არ არის", insecticide: "ქლორპირიფოსი (ფარიანა / ბუგრები / ტკიპები) + იმიდაკლოპრიდი (ფარიანა)", fertilizer: "საჭირო არ არის", notes: "კვირტის გაშლამდე — მოსამზადე სტადიების დამუშავება სავალდებულოა" },
    { stage: "კვირტების დაბერვა / გაშლა", days: [15, 40], fungicide: "სპილენძის სულფატი+გოგირდი (ქეცი) + პირიმეტანილი (ნაცარი)", insecticide: "პირიმიფოს-მეთილი (კოკრიფხამა / ბუგრები)", fertilizer: "N (ადრეული)", notes: "ქეცი — სეზონის პირველი შეწამვლა სავალდებულოა" },
    { stage: "კოკრების გამოჩენა / ყვავილობამდე", days: [40, 60], fungicide: "კრეზოქსიმ-მეთილი (ქეცი / ნაცარი) + ფლუოპირამი+ტრიფლოქსისტრობინი (ნაცარი)", insecticide: "თიაკლოპრიდი (ბუგრები / ჭერჩხები)", fertilizer: "ბორი (ფოთლოვანი) + კალციუმი", notes: "ყვავილობამდე 1 კვირა — ბოტრიტისის კრიტიკული შეწამვლა" },
    { stage: "ყვავილობა", days: [60, 70], fungicide: "კრეზოქსიმ-მეთილი (ქეცი / ნაცარი)", insecticide: "საჭირო არ არის", fertilizer: "ბორი (ფოთლოვანი)", notes: "შეწამვლა მინიმუმი — ფუტკრების დაცვა; დილით ან საღამოს შეწამეთ" },
    { stage: "ყვავილობის დასასრული / გამონასკვა", days: [70, 95], fungicide: "ფლუოპირამი+ტრიფლოქსისტრობინი (ნაცარი) + სპილენძის ჰიდროქსიდი (ქეცი / მონილიოზი)", insecticide: "თიაკლოპრიდი+დელტამეთრინი (ნაყოფქამა / ფსილები / თრიფსი)", fertilizer: "კალციუმი + კალიუმი", notes: "ნაყოფქამა — ყვავილობის დასასრულიდან კრიტიკული აგენტი" },
    { stage: "ნაყოფის ზრდა (3-5 სმ)", days: [95, 130], fungicide: "პროპინები (ქეცი / ალტერნარიოზი) + ტებუკონაზოლი+ტრიფლოქსისტრობინი (ნაცარი / ქეცი)", insecticide: "თიაკლოპრიდი (ნაყოფქამა / ბუგრები / ჩირჩილი) + სპიროდიკლოფენი (ტკიპები)", fertilizer: "კალიუმი + კალციუმი", notes: "ტკიპები + ნაყოფქამა — ნაყოფის ზრდის კრიტიკული პერიოდი" },
    { stage: "ნაყოფის ფორმირება / სიმწიფე", days: [130, 175], fungicide: "პირიმეტანილი (ქეცი / შენახვის სიდამდავრება) + კრეზოქსიმ-მეთილი (ნაცარი)", insecticide: "დელტამეთრინი (ნაყოფქამა / ბუგრები)", fertilizer: "სასუქი მინიმუმამდე შეამცირეთ", notes: "მოსავლამდე 14 დღე — ქიმიური შეწამვლა შეწყვიტეთ" },
  ],
  peach: [
    { stage: "კვირტის გაშლა (ადრეული)", days: [0, 20],  fungicide: "სპილენძის ჰიდროქსიდი / სპილენძის სულფატი (ჭრ. / ბაქ.)", insecticide: "საჭირო არ არის", fertilizer: "N (ადრეული)", notes: "ხვეული ფოთოლი — სეზონის 1-ლი შეწამვლა" },
    { stage: "ყვავილობა",             days: [20, 35],   fungicide: "ციპროდინილი (მონილიოზი / ნაცარი)", insecticide: "საჭირო არ არის", fertilizer: "ბორი (ფოთლოვანი)", notes: "ქიმიური შეწამვლა მინიმუმი" },
    { stage: "ნაყოფის ზრდა",          days: [35, 80],   fungicide: "დიფენოკონაზოლი (ნაცარი) + ბოსკალიდი+პირაკლოსტრობინი (ბოტრ.)", insecticide: "ლამბდა-ციჰალოტრინი (ტკიპა / ხოჭო)", fertilizer: "NPK + კალიუმი", notes: "კლასტეროსპოროზი (ნახვ. ფოთ.) — სკ./კუპ." },
    { stage: "მომწიფება",             days: [80, 120],  fungicide: "ციპროდინილი+ფლუდიოქსონილი (მონილიოზი / ბოტრ.)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი (ხარისხისთვის)", notes: "14 დღე — ქიმიური შეწამვლის შეჩერება" },
  ],
  strawberry: [
    { stage: "ვეგეტაციის დაწყებამდე", days: [0, 20], fungicide: "ტებუკონაზოლი (ფურცელის ლაქი / გვირგვინის ლაჩნობა)", insecticide: "სპიროტეტრამატი (ბუგრები / სპიური სისტემურად)", fertilizer: "კალციუმი + N (ადრეული)", notes: "გვირგვინის ლაჩნობა + ფურცელის ლაქი — სეზონის ადრეული დაავადება" },
    { stage: "საყვავილე ყლორტების გამოჩენა", days: [20, 40], fungicide: "აზოქსისტრობინი+დიფენოკონაზოლი (ნაცარი / ფურცელის ლაქი)", insecticide: "ჰექსითიაზოქსი (ტკიპები) + სპინოსადი (თრიფსი / ჩია)", fertilizer: "NPK 28-28-28 (ფოთლოვანი გელი)", notes: "ტკიპები + თრიფსი — ყლორტის გამოჩენას კრიტიკული მავნებლები" },
    { stage: "ყვავილობა", days: [40, 55], fungicide: "მიკლობუტანილი (ნაცარი) + ციპროდინილი+ფლუდიოქსონილი (ბოტრიტისი)", insecticide: "საჭირო არ არის", fertilizer: "ბორი (ADOB® მიკროელემენტი) + ამინომჯავა ბიოსტიმულატორი", notes: "ბოტრიტისი — ყვავილობის დროს ყველაზე კრიტიკული; შეწამვლა დილით ან საღამოს" },
    { stage: "ნაყოფის გამონასკვა", days: [55, 65], fungicide: "ციპროდინილი+ფლუდიოქსონილი (ბოტრიტისი / სიდამდავრება)", insecticide: "საჭირო არ არის", fertilizer: "NPK 20-10-55 (კალიუმიანი, ფოთლოვანი გელი)", notes: "ბოტრიტისის მე-2 კრიტიკული შეწამვლა; 5 დღე კარანტინი მოსავლამდე" },
    { stage: "ნაყოფის ზრდა", days: [65, 80], fungicide: "ტრიფლოქსისტრობინი+ტებუკონაზოლი (ნაცარი / სიდამდავრება)", insecticide: "ლამბდა-ციჰალოტრინი (ბუგრები / თრიფსი)", fertilizer: "NPK 20-10-55 (კალიუმიანი, ფოთლოვანი გელი)", notes: "კალიუმის დოზა გაზარდეთ — ნაყოფის ხარისხისა და შაქრიანობასათვის" },
    { stage: "სიმწიფის დასაწყისი", days: [80, 100], fungicide: "ტებუკონაზოლი (სიდამდავრება / ფურცელის ლაქი)", insecticide: "სპინოსადი (თრიფსი / ჩია)", fertilizer: "საჭირო არ არის", notes: "3-5 დღე — ქიმიური შეწამვლა შეწყვიტეთ" },
  ],
  sunflower: [
    { stage: "გაღივება",              days: [0, 20],    fungicide: "Bacillus subtilis (თესლის დამუშავება)", insecticide: "საჭირო არ არის", fertilizer: "NPK სტარტ.", notes: "" },
    { stage: "ვეგეტაცია",             days: [20, 55],   fungicide: "დიფენოკონაზოლი (ფომოფსისი / ჟანგი)", insecticide: "ლამბდა-ციჰალოტრინი (ბუგრი / ფარიანა)", fertilizer: "N — 1-ლი დოზა + ბორი", notes: "ჭრაქი — ადრეულ ფაზაში კრიტიკულია" },
    { stage: "კვირტის წარმოქმნა",     days: [55, 85],   fungicide: "ბოსკალიდი+პირაკლოსტრობინი (სკლეროტინია / ბოტრ.)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი + ფოსფორი", notes: "სკლეროტინია — ყველაზე სახიფათო" },
    { stage: "მომწიფება",             days: [85, 115],  fungicide: "საჭირო არ არის", insecticide: "საჭირო არ არის", fertilizer: "საჭირო არ არის", notes: "" },
  ],
  watermelon: [
    { stage: "გაღივება",              days: [0, 20],    fungicide: "ტრიქოდერმინი (ნიადაგის დამუშავება)", insecticide: "საჭირო არ არის", fertilizer: "ფოსფორი (სტარტ.)", notes: "" },
    { stage: "ვეგეტაცია",             days: [20, 45],   fungicide: "მეტალაქსილი-M (ჭრაქის საწინააღმდეგოდ)", insecticide: "იმიდაკლოპრიდი (ბუგრის საწინააღმდეგოდ)", fertilizer: "NPK 15-15-15", notes: "ჭრაქი — ძირითადი საფრთხე" },
    { stage: "ყვავილობა / ნაყოფის ზრდა", days: [45, 75], fungicide: "დიფენოკონაზოლი (ანთრაქნოზი / ნაცარი)", insecticide: "აბამექტინი (ტკიპის საწინააღმდეგოდ)", fertilizer: "კალიუმი + კალციუმი", notes: "" },
    { stage: "მომწიფება",             days: [75, 110],  fungicide: "საჭირო არ არის", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი", notes: "10 დღე — ქიმიური შეწამვლის შეჩერება" },
  ],
  bean: [
    { stage: "გაღივება",              days: [0, 15],    fungicide: "Bacillus subtilis (ფესვების დამუშავება)", insecticide: "საჭირო არ არის", fertilizer: "ფოსფორი + რიზობიუმი (ბაქტ. სასუქი)", notes: "ბაქტ. სასუქი ფესვის კვებისთვის" },
    { stage: "ვეგეტაცია",             days: [15, 40],   fungicide: "დიფენოკონაზოლი (ჟანგი / ანთრაქნოზი)", insecticide: "ლამბდა-ციჰალოტრინი (ბუგრი / ხოჭო)", fertilizer: "NPK (მცირე დოზა)", notes: "" },
    { stage: "ყვავილობა / პარკის ფორმ.", days: [40, 70], fungicide: "სპილენძის სულფატი (ბაქტ. დაავადება)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი", notes: "" },
    { stage: "სიმწიფე",               days: [70, 100],  fungicide: "საჭირო არ არის", insecticide: "საჭირო არ არის", fertilizer: "საჭირო არ არის", notes: "" },
  ],
  cabbage: [
    { stage: "ჩითილი / გადარგვა",    days: [0, 25],    fungicide: "Bacillus subtilis (ნიადაგი / ფესვი)", insecticide: "საჭირო არ არის", fertilizer: "ფოსფორი (სტარტ.)", notes: "" },
    { stage: "ვეგეტაცია",             days: [25, 60],   fungicide: "მეტალაქსილი-M (ჭრაქის საწინააღმდეგოდ)", insecticide: "ტებუფენოზიდი (პეპლის ლარვა — კომბოსტოს ჭია)", fertilizer: "N — 1-ლი დოზა", notes: "კომბოსტოს პეპლის ლარვა — ვიზუალური კონტროლი" },
    { stage: "ქამის წარმოქმნა",        days: [60, 100],  fungicide: "დიფენოკონაზოლი (ალტერნარია / სეპტ.)", insecticide: "ლამბდა-ციჰალოტრინი (პეპ. / ბუგ.)", fertilizer: "კალიუმი + კალციუმი", notes: "" },
    { stage: "მოსავალი",              days: [100, 130], fungicide: "საჭირო არ არის", insecticide: "საჭირო არ არის", fertilizer: "საჭირო არ არის", notes: "14 დღე — ქიმიური შეწამვლის შეჩერება" },
  ],
  onion: [
    { stage: "გაღივება / ადრეული ვეგ.", days: [0, 30],  fungicide: "Bacillus subtilis (ნიადაგი / ფესვი)", insecticide: "საჭირო არ არის", fertilizer: "NPK სტარტ.", notes: "" },
    { stage: "ვეგეტაცია",             days: [30, 70],   fungicide: "მეტალაქსილი-M (ჭრაქის საწინааღმდ.)", insecticide: "იმიდაკლოპრიდი (თრიფსის საწინააღმდეგოდ)", fertilizer: "N + კალიუმი", notes: "ჭრაქი — ძირითადი საფრთხე" },
    { stage: "ბოლქვის ფორმირება",      days: [70, 100],  fungicide: "დიფენოკონაზოლი (სიდამდავრება / ნაცარი)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმის დოზა გაზარდეთ", notes: "" },
    { stage: "სიმწიფე",               days: [100, 130], fungicide: "საჭირო არ არის", insecticide: "საჭირო არ არის", fertilizer: "საჭირო არ არის", notes: "10 დღე — ქიმიური შეწამვლის შეჩერება" },
  ],
  garlic: [
    { stage: "გაღივება",              days: [0, 40],    fungicide: "Bacillus subtilis (კბილის დამუშავება)", insecticide: "საჭირო არ არის", fertilizer: "ფოსფორი (სტარტ.)", notes: "ნიადაგი ტრიქოდერმინით დაამუშავეთ" },
    { stage: "ვეგეტაცია",             days: [40, 90],   fungicide: "მეტალაქსილი-M (ჭრაქის საწინააღმდ.)", insecticide: "საჭირო არ არის", fertilizer: "N + კალიუმი", notes: "" },
    { stage: "სიმწიფე",               days: [90, 130],  fungicide: "საჭირო არ არის", insecticide: "საჭირო არ არის", fertilizer: "საჭირო არ არის", notes: "" },
  ],
  carrot: [
    { stage: "გაღივება",              days: [0, 25],    fungicide: "ტრიქოდერმინი (ნიადაგი)", insecticide: "საჭირო არ არის", fertilizer: "ფოსფორი (სტარტ.)", notes: "" },
    { stage: "ვეგეტაცია",             days: [25, 70],   fungicide: "დიფენოკონაზოლი (ალტერნარია / სეპტ.)", insecticide: "ლამბდა-ციჰალოტრინი (სტაფილოს ჭიის საწ.)", fertilizer: "N + კალიუმი", notes: "" },
    { stage: "ფესვის ზრდა",           days: [70, 110],  fungicide: "ბოსკალიდი+პირაკლოსტრობინი (სიდამდ. / ბოტრ.)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი", notes: "" },
    { stage: "მოსავალი",              days: [110, 150], fungicide: "საჭირო არ არის", insecticide: "საჭირო არ არის", fertilizer: "საჭირო არ არის", notes: "" },
  ],
  rice: [
    { stage: "გაღივება",              days: [0, 25],    fungicide: "ტრიქოდერმინი (ნიადაგი)", insecticide: "საჭირო არ არის", fertilizer: "N სტარტ.", notes: "წყლის სტაბილური შენარჩუნება" },
    { stage: "ვეგეტაცია",             days: [25, 60],   fungicide: "დიფენოკონაზოლი (ბლასტის საწინააღმდეგოდ)", insecticide: "ლამბდა-ციჰალოტრინი (ბუგრი / ბუზი)", fertilizer: "N — 2-ე დოზა", notes: "ბლასტი — ძირითადი საფრთხე" },
    { stage: "ყვავილობა / ჩამოყალ.",  days: [60, 90],   fungicide: "ბოსკალიდი+პირაკლოსტრობინი (ბოტრ. / სიდ.)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი", notes: "" },
    { stage: "სიმწიფე",               days: [90, 130],  fungicide: "საჭირო არ არის", insecticide: "საჭირო არ არის", fertilizer: "საჭირო არ არის", notes: "" },
  ],
  nuts: [
    { stage: "კვირტების გაშლა", days: [0, 25], fungicide: "სპილენძის ოქსიქლორიდი (ლაქიანობა, ბაქტერიული დაავადებები) + გოგირდი (ნაცარი)", insecticide: "დელტამეთრინი (მწვანი მტვრიანა)", fertilizer: "N (ადრეული)", notes: "კვირტების გაშლამდე — ბაქტერიოზი ინფექციის კრიტიკული პერიოდი" },
    { stage: "ნაყოფების გამოჩენა", days: [25, 50], fungicide: "სპილენძის ოქსიქლორიდი (ლაქიანობა) + გოგირდი (ნაცარი)", insecticide: "სპირომეზიფენი (კვირტის ტიკო) + ალფა-ციპერმეთრინი (მწვანები)", fertilizer: "NPK დაბალანსებული", notes: "კვირტის ტიკო — თხილის ერთ-ერთი მავნებელი" },
    { stage: "ნაყოფების ფორმირება", days: [50, 75], fungicide: "კრეზოქსიმ-მეთილი+ბოსკალიდი (ნაცარი, სიდამამლები)", insecticide: "დელტამეთრინი (აბიური ფართოსანა)", fertilizer: "კალიუმი + კალციუმი", notes: "აბიური ფართოსანა — ნაყოფის შიგნის მავნებელი" },
    { stage: "ნაყოფების ზრდა, გულის ფორმირება", days: [75, 110], fungicide: "კრეზოქსიმ-მეთილი+ბოსკალიდი (ნაცარი, სიდამამლები)", insecticide: "ალფა-ციპერმეთრინი (ხარამბუზი, ბუგრები) + ჰექსითიაზოქსი (ტკიპები)", fertilizer: "კალიუმი", notes: "ტკიპები + ხარამბუზი — გულის ფორმირების კრიტიკული პერიოდი" },
    { stage: "ნაჭუჭის ქერის შევსება", days: [110, 135], fungicide: "ბიტერტანოლი (ნაცარი)", insecticide: "ალფა-ციპერმეთრინი (აბიური ფართოსანა)", fertilizer: "კალიუმი", notes: "ნაჭუჭის ქერის შევსება — სათბობი ბოლო ეტაპი" },
    { stage: "მოსავლამდე 20-25 დღით", days: [135, 155], fungicide: "კაფტანი (სიდამამლები)", insecticide: "დელტამეთრინი (აბიური ფართოსანა)", fertilizer: "საჭირო არ არის", notes: "მოსავლამდე 20-25 დღე — ბოლო ქიმიური შეწამვლა" },
    { stage: "მოსავლამდე 10 დღით", days: [155, 165], fungicide: "საჭირო არ არის", insecticide: "დელტამეთრინი (აბიური ფართოსანა)", fertilizer: "საჭირო არ არის", notes: "მოსავლამდე 10 დღე — კარანტინი" },
    { stage: "მოსავლის აღების შემდეგ", days: [165, 195], fungicide: "სპილენძის ოქსიქლორიდი (ლაქიანობა, ბაქტერიული დაავადებები)", insecticide: "დელტამეთრინი (მავნებლების კომპლექსი)", fertilizer: "ფოსფორი + კალიუმი", notes: "მოსავლის შემდეგ — სეზონის დახურვა შეწამვლა სავალდებულოა" },
    { stage: "ფოთოლცვენა", days: [195, 230], fungicide: "საჭირო არ არის", insecticide: "ქლორპირიფოსი (მოსამზადე სტადიები)", fertilizer: "საჭირო არ არის", notes: "ფოთოლცვენის დროს მავნებლის მოსამზადე სტადიების დამუშავება" },
  ],
};
