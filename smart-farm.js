...
const CROP_SCHEDULES = {
  tomato: [
    { stage: "ჩითილი / გადარგვა",    days: [0, 25],    fungicide: "Bacillus subtilis (ფესვების დამუშავება)", insecticide: "საჭირო არ არის", fertilizer: "სუპერფოსფატი (სტარტერი)", notes: "გადარგვამდე ნიადაგი ტრიქოდერმინით დაამუშავეთ" },
    { stage: "ვეგეტაცია",             days: [25, 50],   fungicide: "სპილენძის სულფატი (პროფილაქტიკური)", insecticide: "იმიდაკლოპრიდი (ბუგრის საწინააღმდეგოდ)", fertilizer: "NPK 15-15-15 + მიკროელემენტები", notes: "7-10 დღეში ერთხელ დათვალიერება" },
    { stage: "ყვავილობა",             days: [50, 75],   fungicide: "დიფენოკონაზოლი (ნაცრის საწინააღმდეგოდ) / ბოსკალიდი+პირაკლოსტრობინი", insecticide: "ლამბდა-ციჰალოტრინი (საჭიროების შემთხვევაში)", fertilizer: "ბორი + კალიუმი (ფოთლოვანი შეწამვლა)", notes: "ყვავილობისას შეწამვლა დილით ან საღამოს" },
    { stage: "ნაყოფის შეკვრა",        days: [75, 100],  fungicide: "მეტალაქსილი-M (ფიტოფტოროზის საწინააღმდეგოდ)", insecticide: "აბამექტინი (ტკიპის საწინააღმდეგოდ)", fertilizer: "კალიუმის სულფატი — დოზა გაზარდეთ", notes: "ფიტოფტოროზის მონიტორინგი ყოველდღე" },
    { stage: "მოსავლის მომწიფება",    days: [100, 140], fungicide: "ციპროდინილი+ფლუდიოქსონილი (ნაცრის / სიდამდავრების საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "სასუქი მინიმუმამდე შეამცირეთ", notes: "მოსავლამდე 7-14 დღე — ქიმიური შეწამვლა შეწყვიტეთ" },
  ],
  pepper: [
