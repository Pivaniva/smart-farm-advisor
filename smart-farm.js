...
const CROP_SCHEDULES = {
  tomato: [
    ...
    { stage: "ვეგეტაცია",             days: [25, 50],   fungicide: "სპილ. CuSO₄ (პროფილაქტიკური)", insecticide: "იმიდაკლ. (ბუგრის საწინააღმდეგოდ)", fertilizer: "NPK 15-15-15 + მიკროელემენტები", notes: "7-10 დღეში ერთხელ დათვალიერება" },
    { stage: "ყვავილობა",             days: [50, 75],   fungicide: "დიფენოკონაზ. (ნაცრის საწინააღმდეგოდ) / ბოსკ.+პირ.", insecticide: "ლამბდა-ციჰ. (საჭიროების შემთხვევაში)", fertilizer: "ბორი + კალიუმი (ფოთლოვანი შეწამვლა)", notes: "ყვავილობისას შეწამვლა დილით ან საღამოს" },
    { stage: "ნაყოფის შეკვრა",        days: [75, 100],  fungicide: "მეტალაქს.-M (ფიტოფტოროზის საწინააღმდეგოდ)", insecticide: "აბამექტ. (ტკიპის საწინააღმდეგოდ)", fertilizer: "კალიუმის სულფატი — დოზა გაზარდეთ", notes: "ფიტოფტოროზის მონიტორინგი ყოველდღე" },
    { stage: "მოსავლის მომწიფება",    days: [100, 140], fungicide: "ციპ.+ფლუდ. (ნაცრის / სიდამდავრების საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "სასუქი მინიმუმამდე შეამცირეთ", notes: "მოსავლამდე 7-14 დღე — ქიმიური შეწამვლა შეწყვიტეთ" },
  ],
  pepper: [
    ...
    { stage: "ვეგეტაცია",             days: [30, 60],   fungicide: "სპილ. CuSO₄ — 10 დღეში ერთხელ", insecticide: "იმიდაკლ. (ბუგრის საწინააღმდეგოდ)", fertilizer: "NPK 15-15-15", notes: "" },
    { stage: "ყვავილობა",             days: [60, 85],   fungicide: "დიფენოკონაზ. / ბოსკ.+პირ. (ნაცარი / სიდამდავრება)", insecticide: "ლამბდა-ციჰ. (საჭიროების შემთხვევაში)", fertilizer: "ბორი + კალიუმი (ფოთლოვანი შეწამვლა)", notes: "ბოტრიტისის კონტროლი მნიშვნელოვანია" },
    { stage: "ნაყოფის ზრდა",          days: [85, 120],  fungicide: "მეტალაქს.-M (ფიტოფტოროზის საწინა��ღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმის დოზა გაზარდეთ", notes: "პიკ სეზონზე მორწყვის სტაბილურობა" },
  ...
  cucumber: [
    ...
    { stage: "ვეგეტაცია",             days: [15, 35],   fungicide: "სპილ. CuSO₄ (პროფილაქტიკური)", insecticide: "იმიდაკლ. (ბუგრის საწინააღმდეგოდ)", fertilizer: "NPK 15-15-15", notes: "ჭრაქის პროფილაქტიკა ტენიანობისას" },
    { stage: "ყვავილობა",             days: [35, 55],   fungicide: "მეტალაქს.-M (ჭრაქის საწინააღმდეგოდ)", insecticide: "აბამექტ. (ტკიპის საწინააღმდეგოდ)", fertilizer: "ბორი + კალიუმი (ფოთლოვანი შეწამვლა)", notes: "ფუტკრები — შეწამვლა მხოლოდ საღამოს" },
    { stage: "მოსავალი",              days: [55, 90],   fungicide: "ციპროდინ. (ნაცრის საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმის სულფატი", notes: "7 დღე ადრე — ქიმიური შეწამვლის შეჩერება" },
  ],
  potato: [
    { stage: "გამოღივება",            days: [0, 25],    fungicide: "Bacillus subtilis (ტუბერის დამუშავება)", insecticide: "იმიდაკლ. (ხოჭოს საწინააღმდეგოდ)", fertilizer: "NPK სტარტ. (ფოსფორი)", notes: "ტუბერის წინასწარ დამუშავება სავალდებულოა" },
    { stage: "ვეგეტაცია",             days: [25, 50],   fungicide: "მეტირამი (ფიტოფტოროზის პროფილაქტიკა)", insecticide: "ლამბდა-ციჰ. (კოლორადოს ხოჭოს საწინააღმდეგოდ)", fertilizer: "NPK 15-15-15 + კალციუმი", notes: "კოლორადოს ხოჭოს ყოველდღე თვალყური" },
    { stage: "ტუბერის წარმოქმნა",     days: [50, 75],   fungicide: "მეტალაქს.-M (ფიტოფტოროზის საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმის დოზა გაზარდეთ", notes: "ფიტოფტოროზის მაღალი სეზონი" },
    { stage: "სიმწიფე",               days: [75, 110],  fungicide: "დიფენოკონაზ. (სიდამდავრების საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "სასუქი შეამცირეთ", notes: "მოსავლამდე 14 დღე — ქიმიური შეწამვლის შეჩერება" },
  ],
  maize: [
    ...
    { stage: "ვეგეტაცია (3-6 ფოთოლი)", days: [20, 45], fungicide: "საჭირო არ არის", insecticide: "ლამბდა-ციჰ. (ჭიების საწინააღმდეგოდ)", fertilizer: "ნიტრამონი (N — 1-ლი დოზა)", notes: "ჰერბიციდი — 3-4 ფოთლის ფაზაში" },
    { stage: "ძლიერი ზრდა",           days: [45, 70],   fungicide: "დიფენოკონაზ. (ჟანგი / ჰელმინტოსპოროზი)", insecticide: "ტებუფ. (ღეროს ჭიის საწინააღმდეგოდ)", fertilizer: "ნიტრამონი (N — 2-ე დოზა)", notes: "ღეროს ჭია — ყველაზე სახიფათო" },
  ...
  wheat: [
    ...
    { stage: "კოკრიანობა",            days: [30, 80],   fungicide: "დიფენოკონაზ. (სეპტორია / ჟანგი)", insecticide: "საჭირო არ არის", fertilizer: "ნიტრამონი — ტოპდრესინგი (გაზაფხულზე)", notes: "გაზაფხულის აზოტი — ყველაზე მნიშვნელოვანი" },
    { stage: "ღეროს ზრდა",            days: [80, 120],  fungicide: "დიფენოკონაზ. / ბოსკ.+პირ. (სეპტ. / ჟანგი)", insecticide: "ლამბდა-ციჰ. (ბუგრი / თრიფსი)", fertilizer: "N — 2-ე დოზა", notes: "ჟანგის მონიტორინგი ყოველ 5 დღეში" },
    { stage: "ყვავილობა",             days: [120, 145], fungicide: "ბოსკ.+პირ. (ფუზარიოზის საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "საჭირო არ არის", notes: "ყვავილობის ფაზა — ფუზარიოზის კრიტიკული დრო" },
  ...
  vine: [
    { stage: "კვირტის გაშლა",         days: [0, 20],    fungicide: "Cu(OH)₂ 1%", insecticide: "საჭირო არ არის", fertilizer: "N (კვირტის გაშლამდე)", notes: "ჭრაქის / ნაცრის სეზონის გახსნა" },
    { stage: "5-6 ფოთოლი / ყლორტის ზრდა", days: [20, 50], fungicide: "მეტირამი + დიფენოკონაზ. (ჭრაქი + ნაცარი)", insecticide: "ლამბდა-ციჰ. (ყლორტის ჭიის საწინააღმდეგოდ)", fertilizer: "NPK დაბალანსებული", notes: "ჭრაქი + ნაცარი — ორივე ერთდროულად" },
    { stage: "ყვავილობამდე / ყვავილობა", days: [50, 70], fungicide: "ციპროდინ. + მეტალაქს.-M (ბოტრ. / ჭრ.)", insecticide: "ტებუფ. (Lobesia botrana — ყურძნის ჩრჩილი)", fertilizer: "ბორი (ყვავილობამდე)", notes: "ყვავილობა — ქიმიური შეწამვლა მინიმუმი, ბოტრიტისის პროფილაქტიკა" },
    { stage: "მარცვლის შეკვრა",        days: [70, 100],  fungicide: "ციპ.+ფლუდ. / ბოსკ.+პირ. (ბოტრიტისის საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი + კალციუმი", notes: "" },
    { stage: "მომწიფება",             days: [100, 140], fungicide: "ციპ.+ფლუდ. (სიდამდავრების საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი (გამომწიფება)", notes: "მოსავლამდე 21 დღე — ქიმიური შეწამვლის შეჩერება" },
    { stage: "შემოდგომა / გასხვლა",   days: [140, 200], fungicide: "Cu(OH)₂ (გასხვლის შემდეგ ჭრილობების დასამუშ.)", insecticide: "საჭირო არ არის", fertilizer: "საჭირო არ არის", notes: "ჭრის ჭრილობების დამუშავება სავალდებულოა" },
  ],
  apple: [
    { stage: "კვირტის გაშლა / ყვავილობამდე", days: [0, 30], fungicide: "დიფენოკონაზ. + სპილ. CuSO₄ (ქეცის საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "N სტარტ. (აზოტი)", notes: "ქეცი — სეზონის პირველი შეწამვლა" },
    { stage: "ყვავილობა",             days: [30, 45],   fungicide: "ციპროდინ. (ნაცრის საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "ბორი (ფოთლოვანი შეწამვლა)", notes: "ქიმიური შეწამვლა მინიმუმი — ფუტკრები" },
    { stage: "ნაყოფის ჩამოყალიბება / ზრდა", days: [45, 90], fungicide: "დიფენოკონაზ. (ქეცი / ნაცარი)", insecticide: "ლამბდა-ციჰ. (ვაშლის ჭიის საწინააღმდეგოდ)", fertilizer: "NPK + კალციუმი", notes: "7-10 დღეში ქეცის მონიტორინგი" },
    { stage: "ნაყოფის მომწიფება",      days: [90, 140],  fungicide: "ბოსკ.+პირ. (სიდამდავრების საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი (ნაყოფის ხარისხისთვის)", notes: "14 დღე — ქიმიური შეწამვლის შეჩერება" },
  ],
  peach: [
    { stage: "კვირტის გაშლა (ადრეული)", days: [0, 20],  fungicide: "Cu(OH)₂ / სპილ. CuSO₄ (ჭრ. / ბაქ.)", insecticide: "საჭირო არ არის", fertilizer: "N (ადრეული)", notes: "ხვეული ფოთოლი — სეზონის 1-ლი შეწამვლა" },
    { stage: "ყვავილობა",             days: [20, 35],   fungicide: "ციპროდინ. (მონილიოზი / ნაცარი)", insecticide: "საჭირო არ არის", fertilizer: "ბორი (ფოთლოვანი)", notes: "ქიმიური შეწამვლა მინიმუმი" },
    { stage: "ნაყოფის ზრდა",          days: [35, 80],   fungicide: "დიფენოკონაზ. (ნაცარი) + ბოსკ.+პირ. (ბოტრ.)", insecticide: "ლამბდა-ციჰ. (ტკიპა / ხოჭო)", fertilizer: "NPK + კალიუმი", notes: "კლასტეროსპოროზი (ნახვ. ფოთ.) — სკ./კუპ." },
    { stage: "მომწიფება",             days: [80, 120],  fungicide: "ციპ.+ფლუდ. (მონილიოზი / ბოტრ.)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი (ხარისხისთვის)", notes: "14 დღე — ქიმიური შეწამვლის შეჩერება" },
  ],
  strawberry: [
    { stage: "გაშვება / ვეგეტაცია",   days: [0, 30],    fungicide: "ციპროდინ. (ნაცრის საწინააღმდეგოდ)", insecticide: "აბამექტ. (ტკიპის საწინააღმდეგოდ)", fertilizer: "NPK + კალციუმი", notes: "ნაცარი — ყველ. ტენიანობის ფაზაში" },
    { stage: "ყვავილობა",             days: [30, 55],   fungicide: "ციპ.+ფლუდ. (ბოტრიტისის საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "ბორი + კალიუმი (ფოთლოვანი)", notes: "ბოტრიტისი — ყველაზე კრიტიკული საფრთხე" },
    { stage: "მოსავალი",              days: [55, 90],   fungicide: "ბოსკ.+პირ. (სიდამდავრება / ნაცარი)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი", notes: "5 დღე — ქიმიური შეწამვლის შეჩერება" },
  ],
  sunflower: [
    ...
    { stage: "ვეგეტაცია",             days: [20, 55],   fungicide: "დიფენოკონაზ. (ფომოფსისი / ჟანგი)", insecticide: "ლამბდა-ციჰ. (ბუგრი / ფარიანა)", fertilizer: "N — 1-ლი დოზა + ბორი", notes: "ჭრაქი — ადრეულ ფაზაში კრიტიკულია" },
    { stage: "კვირტის წარმოქმნა",     days: [55, 85],   fungicide: "ბოსკ.+პირ. (სკლეროტინია / ბოტრ.)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი + ფოსფორი", notes: "სკლეროტინია — ყველაზე სახიფათო" },
  ...
  watermelon: [
    ...
    { stage: "ვეგეტაცია",             days: [20, 45],   fungicide: "მეტალაქს.-M (ჭრაქის საწინააღმდეგოდ)", insecticide: "იმიდაკლ. (ბუგრის საწინააღმდეგოდ)", fertilizer: "NPK 15-15-15", notes: "ჭრაქი — ძირითადი საფრთხე" },
    { stage: "ყვავილობა / ნაყოფის ზრდა", days: [45, 75], fungicide: "დიფენოკონაზ. (ანთრაქნოზი / ნაცარი)", insecticide: "აბამექტ. (ტკიპის საწინააღმდეგოდ)", fertilizer: "კალიუმი + კალციუმი", notes: "" },
  ...
  bean: [
    ...
    { stage: "ვეგეტაცია",             days: [15, 40],   fungicide: "დიფენოკონაზ. (ჟანგი / ანთრაქნოზი)", insecticide: "ლამბდა-ციჰ. (ბუგრი / ხოჭო)", fertilizer: "NPK (მცირე დოზა)", notes: "" },
    { stage: "ყვავილობა / პარკის ფორმ.", days: [40, 70], fungicide: "სპილ. CuSO₄ (ბაქტ. დაავადება)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი", notes: "" },
  ...
  cabbage: [
    ...
    { stage: "ვეგეტაცია",             days: [25, 60],   fungicide: "მეტალაქს.-M (ჭრაქის საწინააღმდეგოდ)", insecticide: "ტებუფ. (პეპლის ლარვა — კომბოსტოს ჭია)", fertilizer: "N — 1-ლი დოზა", notes: "კომბოსტოს პეპლის ლარვა — ვიზუალური კონტროლი" },
    { stage: "ქამის წარმოქმნა",        days: [60, 100],  fungicide: "დიფენოკონაზ. (ალტერნარია / სეპტ.)", insecticide: "ლამბდა-ციჰ. (პეპ. / ბუგ.)", fertilizer: "კალიუმი + კალციუმი", notes: "" },
  ...
  onion: [
    ...
    { stage: "ვეგეტაცია",             days: [30, 70],   fungicide: "მეტალაქს.-M (ჭრაქის საწინааღმდ.)", insecticide: "იმიდაკლ. (თრიფსის საწინააღმდეგოდ)", fertilizer: "N + კალიუმი", notes: "ჭრაქი — ძირითადი საფრთხე" },
    { stage: "ბოლქვის ფორმირება",      days: [70, 100],  fungicide: "დიფენოკონაზ. (სიდამდავრება / ნაცარი)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმის დოზა გაზარდეთ", notes: "" },
  ...
  garlic: [
    ...
    { stage: "ვეგეტაცია",             days: [40, 90],   fungicide: "მეტალაქს.-M (ჭრაქის საწინააღმდ.)", insecticide: "საჭირო არ არის", fertilizer: "N + კალიუმი", notes: "" },
  ...
  carrot: [
    ...
    { stage: "ვეგეტაცია",             days: [25, 70],   fungicide: "დიფენოკონაზ. (ალტერნარია / სეპტ.)", insecticide: "ლამბდა-ციჰ. (სტაფილოს ჭიის საწ.)", fertilizer: "N + კალიუმი", notes: "" },
    { stage: "ფესვის ზრდა",           days: [70, 110],  fungicide: "ბოსკ.+პირ. (სიდამდ. / ბოტრ.)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი", notes: "" },
  ...
  rice: [
    ...
    { stage: "ვეგეტაცია",             days: [25, 60],   fungicide: "დიფენოკონაზ. (ბლასტის საწინააღმდეგოდ)", insecticide: "ლამბდა-ციჰ. (ბუგრი / ბუზი)", fertilizer: "N — 2-ე დოზა", notes: "ბლასტი — ძირითადი საფრთხე" },
    { stage: "ყვავილობა / ჩამოყალ.",  days: [60, 90],   fungicide: "ბოსკ.+პირ. (ბოტრ. / სიდ.)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი", notes: "" },
    { stage: "სიმწიფე",               days: [90, 130],  fungicide: "საჭირო არ არის", insecticide: "საჭირო არ არის", fertilizer: "საჭირო არ არის", notes: "" },
  ],
  nuts: [
    { stage: "კვირტის გაშლა",         days: [0, 30],    fungicide: "Cu(OH)₂ 1% (ბაქტ. / ჭრ.)", insecticide: "საჭირო არ არის", fertilizer: "N (კვირტის გაშლამდე)", notes: "ბაქტერიოზი — ადრეულ სეზონში მნიშვნელოვანი" },
    { stage: "ფოთლის ზრდა / ყვავილობა", days: [30, 70], fungicide: "სპილ. CuSO₄ (ბაქტ. / ანთრაქნოზი)", insecticide: "ლამბდა-ციჰ. (ჭიის საწინააღმდ.)", fertilizer: "NPK დაბალანსებული", notes: "2 კვირაში ერთხელ შეწამვლა" },
    { stage: "ნაყოფის ფორმირება",      days: [70, 120],  fungicide: "დიფენოკონაზ. (ნაცრის საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი + კალციუმი", notes: "" },
...
const PRODUCT_KEYWORDS = {
  ridomil:    ["რიდომილ", "მეტალაქს"],
  score:      ["სკორი", "დიფენოკო"],
  horus:      ["ჰორუსი", "ციპროდინ"],
  switch_:    ["სვიჩი", "ფლუდ"],
  signum:     ["სიგნუმი", "ბოსკ"],
  cuproxat:   ["კუპროქ", "CuSO₄"],
  polyram:    ["პოლირამ", "მეტირამ"],
  bordeaux:   ["ბორდოს", "Cu(OH)"],
  fitosporin: ["ფიტოსპ", "Bacillus"],
  trichoderm: ["ტრიქოდერმინი"],
  karate:     ["კარატე", "ლამბდა"],
  confidor:   ["კონფიდ", "იმიდაკლ"],
  mospilan:   ["მოსპილანი"],
  nomolt:     ["ნომოლტ", "ტებუფ"],
  vertimec:   ["ვერტიმ", "აბამექტ"],
  nitramon:   ["ნიტრამონი"],
  superph:    ["სუპერფოსფ"],
  kaliumi:    ["კალიუმ"],
  npk:        ["NPK", "15-15-15"],
