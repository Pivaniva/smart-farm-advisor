...
const CROP_SCHEDULES = {
  ...
  nuts: [
    { stage: "კვირტის გაშლა",         days: [0, 30],    fungicide: "სპილენძის ჰიდროქსიდი 1% (ბაქტ. / ჭრ.)", insecticide: "საჭირო არ არის", fertilizer: "N (კვირტის გაშლამდე)", notes: "ბაქტერიოზი — ადრეულ სეზონში მნიშვნელოვანი" },
    { stage: "ფოთლის ზრდა / ყვავილობა", days: [30, 70], fungicide: "სპილენძის სულფატი (ბაქტ. / ანთრაქნოზი)", insecticide: "ლამბდა-ციჰალოტრინი (ჭიის საწინააღმდ.)", fertilizer: "NPK დაბალანსებული", notes: "2 კვირაში ერთხელ შეწამვლა" },
    { stage: "ნაყოფის ფორმირება",      days: [70, 120],  fungicide: "დიფენოკონაზოლი (ნაცრის საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი + კალციუმი", notes: "" },
    { stage: "სიმწიფე",               days: [120, 180], fungicide: "საჭირო არ არის", insecticide: "საჭირო არ არის", fertilizer: "საჭირო არ არის", notes: "21 დღე — ქიმიური შეწამვლის შეჩერება" },
  ],
};
