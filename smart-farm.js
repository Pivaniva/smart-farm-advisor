...
const CROP_SCHEDULES = {
  tomato: [
    { stage: "ჩითილი / ადრული ვეგეტაცია", days: [0, 25], fungicide: "აზოქსისტრობინი (ალტერნარიოზი) + ციმოქსანილი+მანქოზები (ფიტოფთოროზი)", insecticide: "სპინოსადი (თრიფსი / ნადგარები) + ციპერმეთრინი (ბუგრები)", fertilizer: "სუპერფოსფატი (სტარტერი)", notes: "გადარგვამდე ნიადაგი ტრიქოდერმინით დაამუშავეთ" },
    { stage: "ვეგეტაცია", days: [25, 50], fungicide: "მანქოზები (ფიტოფთოროზი / ალტერნარიოზი პროფილაქტიკა)", insecticide: "მეთომილი (ჩია / ბუგრები) + აცეტამიპრიდი (სპიური)", fertilizer: "NPK 15-15-15 + მიკროელემენტები", notes: "7-10 დღეში ვიზუალური დათვალიერება სავალდებულოა" },
  ...
  nuts: [
    ...
    { stage: "ნაყოფების გამოჩენა", days: [25, 50], fungicide: "სპილენძის ოქსიქლორიდი (ლაქიანობა) + გოგირდი (ნაცარი)", insecticide: "სპიროდიკლოფენი (კვირტის ტიკო) + ალფა-ციპერმეთრინი (მწვანები)", fertilizer: "NPK დაბალანსებული", notes: "კვირტის ტიკო — თხილის ერთ-ერთი მავნებელი" },
