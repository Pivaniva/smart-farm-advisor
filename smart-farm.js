...
const CROP_SCHEDULES = {
  ...
  cucumber: [
    { stage: "გაღივება",              days: [0, 15],    fungicide: "ტრიქოდერმინი (ნიადაგის დამუშავება)", insecticide: "საჭირო არ არის", fertilizer: "NPK სტარტ. (ფოსფორი)", notes: "" },
    { stage: "ვეგეტაცია",             days: [15, 35],   fungicide: "სპილენძის სულფატი (პროფილაქტიკური)", insecticide: "იმიდაკლოპრიდი (ბუგრის საწინააღმდეგოდ)", fertilizer: "NPK 15-15-15", notes: "ჭრაქის პროფილაქტიკა ტენიანობისას" },
    { stage: "ყვავილობა",             days: [35, 55],   fungicide: "მეტალაქსილი-M (ჭრაქის საწინააღმდეგოდ)", insecticide: "აბამექტინი (ტკიპის საწინააღმდეგოდ)", fertilizer: "ბორი + კალიუმი (ფოთლოვანი შეწამვლა)", notes: "ფუტკრები — შეწამვლა მხოლოდ საღამოს" },
    { stage: "მოსავალი",              days: [55, 90],   fungicide: "ციპროდინილი (ნაცრის საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმის სულფატი", notes: "7 დღე ადრე — ქიმიური შეწამვლის შეჩერება" },
  ],
  potato: [
