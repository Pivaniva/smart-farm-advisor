...
const CROP_SCHEDULES = {
  tomato: [
    { stage: "ჩითილი / გადარგვა",    days: [0, 25],    fungicide: "ფიტოსპორინი (ფესვების დამუშავება)", insecticide: "საჭირო არ არის", fertilizer: "სუპერფოსფატი (სტარტერი)", notes: "გადარგვამდე ნიადაგი ტრიქოდერმინით დაამუშავეთ" },
    { stage: "ვეგეტაცია",             days: [25, 50],   fungicide: "კუპროქსატი (პროფილაქტიკური)", insecticide: "კონფიდორი (ბუგრის საწინააღმდეგოდ)", fertilizer: "NPK 15-15-15 + მიკროელემენტები", notes: "7-10 დღეში ერთხელ დათვალიერება" },
    { stage: "ყვავილობა",             days: [50, 75],   fungicide: "სკორი (ნაცრის საწინააღმდეგოდ) / სიგნუმი", insecticide: "კარატე ზეონი (საჭიროების შემთხვევაში)", fertilizer: "ბორი + კალიუმი (ფოთლოვანი შეწამვლა)", notes: "ყვავილობისას შეწამვლა დილით ან საღამოს" },
    { stage: "ნაყოფის შეკვრა",        days: [75, 100],  fungicide: "რიდომილ გოლდი (ფიტოფტოროზის საწინააღმდეგოდ)", insecticide: "ვერტიმეკი (ტკიპის საწინააღმდეგოდ)", fertilizer: "კალიუმის სულფატი — დოზა გაზარდეთ", notes: "ფიტოფტოროზის მონიტორინგი ყოველდღე" },
    { stage: "მოსავლის მომწიფება",    days: [100, 140], fungicide: "სვიჩი (ნაცრის / სიდამდავრების საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "სასუქი მინიმუმამდე შეამცირეთ", notes: "მოსავლამდე 7-14 დღე — ქიმიური შეწამვლა შეწყვიტეთ" },
  ],
  pepper: [
    { stage: "ჩითილი / გადარგვა",    days: [0, 30],    fungicide: "ფიტოსპორინი (ფესვების დამუშავება)", insecticide: "საჭირო არ არის", fertilizer: "სტარტ. NPK (ფოსფორი)", notes: "ფიტოფტოროზის საწინააღმდეგო ნიადაგი" },
    { stage: "ვეგეტაცია",             days: [30, 60],   fungicide: "კუპროქსატი — 10 დღეში ერთხელ", insecticide: "კონფიდორი (ბუგრის საწინააღმდეგოდ)", fertilizer: "NPK 15-15-15", notes: "" },
    { stage: "ყვავილობა",             days: [60, 85],   fungicide: "სკორი / სიგნუმი (ნაცარი / სიდამდავრება)", insecticide: "კარატე ზეონი (საჭიროების შემთხვევაში)", fertilizer: "ბორი + კალიუმი (ფოთლოვანი შეწამვლა)", notes: "ბოტრიტისის კონტროლი მნიშვნელოვანია" },
    { stage: "ნაყოფის ზრდა",          days: [85, 120],  fungicide: "რიდომილ გოლდი (ფიტოფტოროზის საწინა��ღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმის დოზა გაზარდეთ", notes: "პიკ სეზონზე მორწყვის სტაბილურობა" },
  ...
  cucumber: [
    ...
    { stage: "ვეგეტაცია",             days: [15, 35],   fungicide: "კუპროქსატი (პროფილაქტიკური)", insecticide: "კონფიდორი (ბუგრის საწინააღმდეგოდ)", fertilizer: "NPK 15-15-15", notes: "ჭრაქის პროფილაქტიკა ტენიანობისას" },
    { stage: "ყვავილობა",             days: [35, 55],   fungicide: "რიდომილ გოლდი (ჭრაქის საწინააღმდეგოდ)", insecticide: "ვერტიმეკი (ტკიპის საწინააღმდეგოდ)", fertilizer: "ბორი + კალიუმი (ფოთლოვანი შეწამვლა)", notes: "ფუტკრები — შეწამვლა მხოლოდ საღამოს" },
    { stage: "მოსავალი",              days: [55, 90],   fungicide: "ჰორუსი (ნაცრის საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმის სულფატი", notes: "7 დღე ადრე — ქიმიური შეწამვლის შეჩერება" },
  ],
  tomato_field: [],
  potato: [
    { stage: "გამოღივება",            days: [0, 25],    fungicide: "ფიტოსპორინი (ტუბერის დამუშავება)", insecticide: "კონფიდორი (ხოჭოს საწინააღმდეგოდ)", fertilizer: "NPK სტარტ. (ფოსფორი)", notes: "ტუბერის წინასწარ დამუშავება სავალდებულოა" },
    { stage: "ვეგეტაცია",             days: [25, 50],   fungicide: "პოლირამი (ფიტოფტოროზის პროფილაქტიკა)", insecticide: "კარატე ზეონი (კოლორადოს ხოჭოს საწინააღმდეგოდ)", fertilizer: "NPK 15-15-15 + კალციუმი", notes: "კოლორადოს ხოჭოს ყოველდღე თვალყური" },
    { stage: "ტუბერის წარმოქმნა",     days: [50, 75],   fungicide: "რიდომილ გოლდი (ფიტოფტოროზის საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმის დოზა გაზარდეთ", notes: "ფიტოფტოროზის მაღალი სეზონი" },
    { stage: "სიმწიფე",               days: [75, 110],  fungicide: "სკორი (სიდამდავრების საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "სასუქი შეამცირეთ", notes: "მოსავლამდე 14 დღე — ქიმიური შეწამვლის შეჩერება" },
  ],
  maize: [
    { stage: "გაღივება",              days: [0, 20],    fungicide: "ფიტოსპორინი (თესლის დამუშავება)", insecticide: "საჭირო არ არის", fertilizer: "NPK 10-20-20 სტარტ.", notes: "თესლის დამუშავება სავალდებულოა" },
    { stage: "ვეგეტაცია (3-6 ფოთოლი)", days: [20, 45], fungicide: "საჭირო არ არის", insecticide: "კარატე ზეონი (ჭიების საწინააღმდეგოდ)", fertilizer: "ნიტრამონი (N — 1-ლი დოზა)", notes: "ჰერბიციდი — 3-4 ფოთლის ფაზაში" },
    { stage: "ძლიერი ზრდა",           days: [45, 70],   fungicide: "სკორი (ჟანგი / ჰელმინტოსპოროზი)", insecticide: "ნომოლტი (ღეროს ჭიის საწინააღმდეგოდ)", fertilizer: "ნიტრამონი (N — 2-ე დოზა)", notes: "ღეროს ჭია — ყველაზე სახიფათო" },
  ...
  wheat: [
    ...
    { stage: "კოკრიანობა",            days: [30, 80],   fungicide: "სკორი (სეპტორია / ჟანგი)", insecticide: "საჭირო არ არის", fertilizer: "ნიტრამონი — ტოპდრესინგი (გაზაფხულზე)", notes: "გაზაფხულის აზოტი — ყველაზე მნიშვნელოვანი" },
    { stage: "ღეროს ზრდა",            days: [80, 120],  fungicide: "სკორი / სიგნუმი (სეპტ. / ჟანგი)", insecticide: "კარატე ზეონი (ბუგრი / თრიფსი)", fertilizer: "N — 2-ე დოზა", notes: "ჟანგის მონიტორინგი ყოველ 5 დღეში" },
    { stage: "ყვავილობა",             days: [120, 145], fungicide: "სიგნუმი (ფუზარიოზის საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "საჭირო არ არის", notes: "ყვავილობის ფაზა — ფუზარიოზის კრიტიკული დრო" },
  ...
  vine: [
    { stage: "კვირტის გაშლა",         days: [0, 20],    fungicide: "ბორდოს სითხე 1%", insecticide: "საჭირო არ არის", fertilizer: "N (კვირტის გაშლამდე)", notes: "ჭრაქის / ნაცრის სეზონის გახსნა" },
    { stage: "5-6 ფოთოლი / ყლორტის ზრდა", days: [20, 50], fungicide: "პოლირამი + სკორი (ჭრაქი + ნაცარი)", insecticide: "კარატე ზეონი (ყლორტის ჭიის საწინააღმდეგოდ)", fertilizer: "NPK დაბალანსებული", notes: "ჭრაქი + ნაცარი — ორივე ერთდროულად" },
    { stage: "ყვავილობამდე / ყვავილობა", days: [50, 70], fungicide: "ჰორუსი + რიდომილ გოლდი (ბოტრ. / ჭრ.)", insecticide: "ნომოლტი (Lobesia botrana — ყურძნის ჩრჩილი)", fertilizer: "ბორი (ყვავილობამდე)", notes: "ყვავილობა — ქიმიური შეწამვლა მინიმუმი, ბოტრიტისის პროფილაქტიკა" },
    { stage: "მარცვლის შეკვრა",        days: [70, 100],  fungicide: "სვიჩი / სიგნუმი (ბოტრიტისის საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი + კალციუმი", notes: "" },
    { stage: "მომწიფება",             days: [100, 140], fungicide: "სვიჩი (სიდამდავრების საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი (გამომწიფება)", notes: "მოსავლამდე 21 დღე — ქიმიური შეწამვლის შეჩერება" },
    { stage: "შემოდგომა / გასხვლა",   days: [140, 200], fungicide: "ბორდოს სითხე (გასხვლის შემდეგ ჭრილობების დასამუშ.)", insecticide: "საჭირო არ არის", fertilizer: "საჭირო არ არის", notes: "ჭრის ჭრილობების დამუშავება სავალდებულოა" },
  ],
  apple: [
    { stage: "კვირტის გაშლა / ყვავილობამდე", days: [0, 30], fungicide: "სკორი + კუპროქსატი (ქეცის საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "N სტარტ. (აზოტი)", notes: "ქეცი — სეზონის პირველი შეწამვლა" },
    { stage: "ყვავილობა",             days: [30, 45],   fungicide: "ჰორუსი (ნაცრის საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "ბორი (ფოთლოვანი შეწამვლა)", notes: "ქიმიური შეწამვლა მინიმუმი — ფუტკრები" },
    { stage: "ნაყოფის ჩამოყალიბება / ზრდა", days: [45, 90], fungicide: "სკორი (ქეცი / ნაცარი)", insecticide: "კარატე ზეონი (ვაშლის ჭიის საწინააღმდეგოდ)", fertilizer: "NPK + კალციუმი", notes: "7-10 დღეში ქეცის მონიტორინგი" },
    { stage: "ნაყოფის მომწიფება",      days: [90, 140],  fungicide: "სიგნუმი (სიდამდავრების საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი (ნაყოფის ხარისხისთვის)", notes: "14 დღე — ქიმიური შეწამვლის შეჩერება" },
  ],
  peach: [
    { stage: "კვირტის გაშლა (ადრეული)", days: [0, 20],  fungicide: "ბორდოს სითხე / კუპროქსატი (ჭრ. / ბაქ.)", insecticide: "საჭირო არ არის", fertilizer: "N (ადრეული)", notes: "ხვეული ფოთოლი — სეზონის 1-ლი შეწამვლა" },
    { stage: "ყვავილობა",             days: [20, 35],   fungicide: "ჰორუსი (მონილიოზი / ნაცარი)", insecticide: "საჭირო არ არის", fertilizer: "ბორი (ფოთლოვანი)", notes: "ქიმიური შეწამვლა მინიმუმი" },
    { stage: "ნაყოფის ზრდა",          days: [35, 80],   fungicide: "სკორი (ნაცარი) + სიგნუმი (ბოტრ.)", insecticide: "კარატე ზეონი (ტკიპა / ხოჭო)", fertilizer: "NPK + კალიუმი", notes: "კლასტეროსპოროზი (ნახვ. ფოთ.) — სკ./კუპ." },
    { stage: "მომწიფება",             days: [80, 120],  fungicide: "სვიჩი (მონილიოზი / ბოტრ.)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი (ხარისხისთვის)", notes: "14 დღე — ქიმიური შეწამვლის შეჩერება" },
  ],
  strawberry: [
    { stage: "გაშვება / ვეგეტაცია",   days: [0, 30],    fungicide: "ჰორუსი (ნაცრის საწინააღმდეგოდ)", insecticide: "ვერტიმეკი (ტკიპის საწინააღმდეგოდ)", fertilizer: "NPK + კალციუმი", notes: "ნაცარი — ყველ. ტენიანობის ფაზაში" },
    { stage: "ყვავილობა",             days: [30, 55],   fungicide: "სვიჩი (ბოტრიტისის საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "ბორი + კალიუმი (ფოთლოვანი)", notes: "ბოტრიტისი — ყველაზე კრიტიკული საფრთხე" },
    { stage: "მოსავალი",              days: [55, 90],   fungicide: "სიგნუმი (სიდამდავრება / ნაცარი)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი", notes: "5 დღე — ქიმიური შეწამვლის შეჩერება" },
  ],
  sunflower: [
    { stage: "გაღივება",              days: [0, 20],    fungicide: "ფიტოსპორინი (თესლის დამუშავება)", insecticide: "საჭირო არ არის", fertilizer: "NPK სტარტ.", notes: "" },
    { stage: "ვეგეტაცია",             days: [20, 55],   fungicide: "სკორი (ფომოფსისი / ჟანგი)", insecticide: "კარატე ზეონი (ბუგრი / ფარიანა)", fertilizer: "N — 1-ლი დოზა + ბორი", notes: "ჭრაქი — ადრეულ ფაზაში კრიტიკულია" },
    { stage: "კვირტის წარმოქმნა",     days: [55, 85],   fungicide: "სიგნუმი (სკლეროტინია / ბოტრ.)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი + ფოსფორი", notes: "სკლეროტინია — ყველაზე სახიფათო" },
  ...
  watermelon: [
    ...
    { stage: "ვეგეტაცია",             days: [20, 45],   fungicide: "რიდომილ გოლდი (ჭრაქის საწინააღმდეგოდ)", insecticide: "კონფიდორი (ბუგრის საწინააღმდეგოდ)", fertilizer: "NPK 15-15-15", notes: "ჭრაქი — ძირითადი საფრთხე" },
    { stage: "ყვავილობა / ნაყოფის ზრდა", days: [45, 75], fungicide: "სკორი (ანთრაქნოზი / ნაცარი)", insecticide: "ვერტიმეკი (ტკიპის საწინააღმდეგოდ)", fertilizer: "კალიუმი + კალციუმი", notes: "" },
  ...
  bean: [
    { stage: "გაღივება",              days: [0, 15],    fungicide: "ფიტოსპორინი (ფესვების დამუშავება)", insecticide: "საჭირო არ არის", fertilizer: "ფოსფორი + რიზობიუმი (ბაქტ. სასუქი)", notes: "ბაქტ. სასუქი ფესვის კვებისთვის" },
    { stage: "ვეგეტაცია",             days: [15, 40],   fungicide: "სკორი (ჟანგი / ანთრაქნოზი)", insecticide: "კარატე ზეონი (ბუგრი / ხოჭო)", fertilizer: "NPK (მცირე დოზა)", notes: "" },
    { stage: "ყვავილობა / პარკის ფორმ.", days: [40, 70], fungicide: "კუპროქსატი (ბაქტ. დაავადება)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი", notes: "" },
    { stage: "სიმწიფე",               days: [70, 100],  fungicide: "საჭირო არ არის", insecticide: "საჭირო არ არის", fertilizer: "საჭირო არ არის", notes: "" },
  ],
  cabbage: [
    { stage: "ჩითილი / გადარგვა",    days: [0, 25],    fungicide: "ფიტოსპორინი (ნიადაგი / ფესვი)", insecticide: "საჭირო არ არის", fertilizer: "ფოსფორი (სტარტ.)", notes: "" },
    { stage: "ვეგეტაცია",             days: [25, 60],   fungicide: "რიდომილ გოლდი (ჭრაქის საწინააღმდეგოდ)", insecticide: "ნომოლტი (პეპლის ლარვა — კომბოსტოს ჭია)", fertilizer: "N — 1-ლი დოზა", notes: "კომბოსტოს პეპლის ლარვა — ვიზუალური კონტროლი" },
    { stage: "ქამის წარმოქმნა",        days: [60, 100],  fungicide: "სკორი (ალტერნარია / სეპტ.)", insecticide: "კარატე ზეონი (პეპ. / ბუგ.)", fertilizer: "კალიუმი + კალციუმი", notes: "" },
  ...
  onion: [
    { stage: "გაღივება / ადრეული ვეგ.", days: [0, 30],  fungicide: "ფიტოსპორინი (ნიადაგი / ფესვი)", insecticide: "საჭირო არ არის", fertilizer: "NPK სტარტ.", notes: "" },
    { stage: "ვეგეტაცია",             days: [30, 70],   fungicide: "რიდომილ გოლდი (ჭრაქის საწინааღმდ.)", insecticide: "კონფიდორი (თრიფსის საწინააღმდეგოდ)", fertilizer: "N + კალიუმი", notes: "ჭრაქი — ძირითადი საფრთხე" },
    { stage: "ბოლქვის ფორმირება",      days: [70, 100],  fungicide: "სკორი (სიდამდავრება / ნაცარი)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმის დოზა გაზარდეთ", notes: "" },
  ...
  garlic: [
    { stage: "გაღივება",              days: [0, 40],    fungicide: "ფიტოსპორინი (კბილის დამუშავება)", insecticide: "საჭირო არ არის", fertilizer: "ფოსფორი (სტარტ.)", notes: "ნიადაგი ტრიქოდერმინით დაამუშავეთ" },
    { stage: "ვეგეტაცია",             days: [40, 90],   fungicide: "რიდომილ გოლდი (ჭრაქის საწინააღმდ.)", insecticide: "საჭირო არ არის", fertilizer: "N + კალიუმი", notes: "" },
  ...
  carrot: [
    ...
    { stage: "ვეგეტაცია",             days: [25, 70],   fungicide: "სკორი (ალტერნარია / სეპტ.)", insecticide: "კარატე ზეონი (სტაფილოს ჭიის საწ.)", fertilizer: "N + კალიუმი", notes: "" },
    { stage: "ფესვის ზრდა",           days: [70, 110],  fungicide: "სიგნუმი (სიდამდ. / ბოტრ.)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი", notes: "" },
  ...
  rice: [
    ...
    { stage: "ვეგეტაცია",             days: [25, 60],   fungicide: "სკორი (ბლასტის საწინააღმდეგოდ)", insecticide: "კარატე ზეონი (ბუგრი / ბუზი)", fertilizer: "N — 2-ე დოზა", notes: "ბლასტი — ძირითადი საფრთხე" },
    { stage: "ყვავილობა / ჩამოყალ.",  days: [60, 90],   fungicide: "სიგნუმი (ბოტრ. / სიდ.)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი", notes: "" },
    { stage: "სიმწიფე",               days: [90, 130],  fungicide: "საჭირო არ არის", insecticide: "საჭირო არ არის", fertilizer: "საჭირო არ არის", notes: "" },
  ],
  nuts: [
    { stage: "კვირტის გაშლა",         days: [0, 30],    fungicide: "ბორდოს სითხე 1% (ბაქტ. / ჭრ.)", insecticide: "საჭირო არ არის", fertilizer: "N (კვირტის გაშლამდე)", notes: "ბაქტერიოზი — ადრეულ სეზონში მნიშვნელოვანი" },
    { stage: "ფოთლის ზრდა / ყვავილობა", days: [30, 70], fungicide: "კუპროქსატი (ბაქტ. / ანთრაქნოზი)", insecticide: "კარატე ზეონი (ჭიის საწინააღმდ.)", fertilizer: "NPK დაბალანსებული", notes: "2 კვირაში ერთხელ შეწამვლა" },
    { stage: "ნაყოფის ფორმირება",      days: [70, 120],  fungicide: "სკორი (ნაცრის საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი + კალციუმი", notes: "" },
