...
const CROP_SCHEDULES = {
  ...
  strawberry: [
    { stage: "გაშვება / ვეგეტაცია",   days: [0, 30],    fungicide: "ციპროდინილი (ნაცრის საწინააღმდეგოდ)", insecticide: "აბამექტინი (ტკიპის საწინააღმდეგოდ)", fertilizer: "NPK + კალციუმი", notes: "ნაცარი — ყველ. ტენიანობის ფაზაში" },
    { stage: "ყვავილობა",             days: [30, 55],   fungicide: "ციპროდინილი+ფლუდიოქსონილი (ბოტრიტისის საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "ბორი + კალიუმი (ფოთლოვანი)", notes: "ბოტრიტისი — ყველაზე კრიტიკული საფრთხე" },
    { stage: "მოსავალი",              days: [55, 90],   fungicide: "ბოსკალიდი+პირაკლოსტრობინი (სიდამდავრება / ნაცარი)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი", notes: "5 დღე — ქიმიური შეწამვლის შეჩერება" },
  ],
  sunflower: [
