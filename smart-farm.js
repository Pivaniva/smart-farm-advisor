...
const CROP_SCHEDULES = {
  ...
  apple: [
    { stage: "კვირტის გაშლა / ყვავილობამდე", days: [0, 30], fungicide: "დიფენოკონაზოლი + სპილენძის სულფატი (ქეცის საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "N სტარტ. (აზოტი)", notes: "ქეცი — სეზონის პირველი შეწამვლა" },
    { stage: "ყვავილობა",             days: [30, 45],   fungicide: "ციპროდინილი (ნაცრის საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "ბორი (ფოთლოვანი შეწამვლა)", notes: "ქიმიური შეწამვლა მინიმუმი — ფუტკრები" },
    { stage: "ნაყოფის ჩამოყალიბება / ზრდა", days: [45, 90], fungicide: "დიფენოკონაზოლი (ქეცი / ნაცარი)", insecticide: "ლამბდა-ციჰალოტრინი (ვაშლის ჭიის საწინააღმდეგოდ)", fertilizer: "NPK + კალციუმი", notes: "7-10 დღეში ქეცის მონიტორინგი" },
    { stage: "ნაყოფის მომწიფება",      days: [90, 140],  fungicide: "ბოსკალიდი+პირაკლოსტრობინი (სიდამდავრების საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი (ნაყოფის ხარისხისთვის)", notes: "14 დღე — ქიმიური შეწამვლის შეჩერება" },
  ],
  peach: [
