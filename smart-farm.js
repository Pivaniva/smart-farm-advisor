...
const CROP_SCHEDULES = {
  ...
  vine: [
    { stage: "კვირტის გაშლა",         days: [0, 20],    fungicide: "სპილენძის ჰიდროქსიდი 1%", insecticide: "საჭირო არ არის", fertilizer: "N (კვირტის გაშლამდე)", notes: "ჭრაქის / ნაცრის სეზონის გახსნა" },
    { stage: "5-6 ფოთოლი / ყლორტის ზრდა", days: [20, 50], fungicide: "მეტირამი + დიფენოკონაზოლი (ჭრაქი + ნაცარი)", insecticide: "ლამბდა-ციჰალოტრინი (ყლორტის ჭიის საწინააღმდეგოდ)", fertilizer: "NPK დაბალანსებული", notes: "ჭრაქი + ნაცარი — ორივე ერთდროულად" },
    { stage: "ყვავილობამდე / ყვავილობა", days: [50, 70], fungicide: "ციპროდინილი + მეტალაქსილი-M (ბოტრ. / ჭრ.)", insecticide: "ტებუფენოზიდი (Lobesia botrana — ყურძნის ჩრჩილი)", fertilizer: "ბორი (ყვავილობამდე)", notes: "ყვავილობა — ქიმიური შეწამვლა მინიმუმი, ბოტრიტისის პროფილაქტიკა" },
    { stage: "მარცვლის შეკვრა",        days: [70, 100],  fungicide: "ციპროდინილი+ფლუდიოქსონილი / ბოსკალიდი+პირაკლოსტრობინი (ბოტრიტისის საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი + კალციუმი", notes: "" },
    { stage: "მომწიფება",             days: [100, 140], fungicide: "ციპროდინილი+ფლუდიოქსონილი (სიდამდავრების საწინააღმდეგოდ)", insecticide: "საჭირო არ არის", fertilizer: "კალიუმი (გამომწიფება)", notes: "მოსავლამდე 21 დღე — ქიმიური შეწამვლის შეჩერება" },
    { stage: "შემოდგომა / გასხვლა",   days: [140, 200], fungicide: "სპილენძის ჰიდროქსიდი (გასხვლის შემდეგ ჭრილობების დასამუშ.)", insecticide: "საჭირო არ არის", fertilizer: "საჭირო არ არის", notes: "ჭრის ჭრილობების დამუშავება სავალდებულოა" },
  ],
  apple: [
